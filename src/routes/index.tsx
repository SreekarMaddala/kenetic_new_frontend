...
const STATS = [
  ...
  { value: "₹655Cr", label: "Budget Managed" },
  { value: "98.2%", label: "AI Accuracy" },
  { value: "42", label: "Vendors Mapped" },
];
...
const ROW1 = [
  { name: "L&T Construction", icon: "🏗️" },
  { name: "Tata Projects", icon: "🏢" },
  { name: "DLF Developers", icon: "🏡" },
  { name: "Godrej Properties", icon: "🧱" },
  { name: "Shapoorji Pallonji", icon: "🚧" },
  { name: "Sobha Ltd", icon: "📐" },
  { name: "Prestige Group", icon: "🏛️" },
  { name: "Brigade Group", icon: "🏗️" },
];
const ROW2 = [
  { name: "NSE India", icon: "📈" },
  { name: "TATA AIA", icon: "🛡️" },
  { name: "YES BANK", icon: "💳" },
  { name: "CRED", icon: "💎" },
  { name: "THERMAX", icon: "🔥" },
  { name: "Shoppers Stop", icon: "🛍️" },
  { name: "CRISIL Rating", icon: "📊" },
  { name: "Emcure Pharma", icon: "💊" },
];
const ROW3 = [
  { name: "Lodha Group", icon: "🏙️" },
  { name: "Mahindra Lifespace", icon: "🌿" },
  { name: "Oberoi Realty", icon: "⭐" },
  { name: "Phoenix Mills", icon: "🛒" },
  { name: "Kolte-Patil", icon: "🏠" },
  { name: "Embassy Group", icon: "🔷" },
  { name: "Puravankara", icon: "🏰" },
  { name: "Hiranandani", icon: "🌆" },
];

const TESTIMONIALS = [
  {
    quote:
      "Kinetic cut our invoice processing time by 80%. The AI extraction is scarily accurate — even for handwritten field bills.",
    name: "Rajesh Kumar",
  ...
  {
    quote:
      "Having live stock visibility across 6 sites from one screen is a game changer. No more surprise shortages.",
    name: "Priya Nair",
    role: "Site Engineer",
  ...
  {
    quote:
      "The approval workflow alone saved us from 3 financial disputes last quarter. Full audit trail is invaluable.",
    name: "Vikas Kulkarni",
  ...
  return (
    <div style={{ overflow: "hidden", width: "100%" }}>
      <div
        ...
        className={dir === "left" ? "marquee-l" : "marquee-r"}
      >
        {doubled.map((item, i) => (
          <LogoCard key={i} name={item.name} icon={item.icon} />
        ))}
      </div>
    </div>
  );
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.42)", marginBottom: 6 }}>
            {t.role}
          </div>
          {/* company badge */}
          <span
    ...
    <div style={{ minHeight: "100vh", background: "#080809", color: "white", overflowX: "hidden" }}>
        ...
        >
          ...
          <div
            style={{
              ...
              gap: 14,
              marginTop: 32,
              animation: "hFadeUp .8s ease .65s both",
            }}
          >
              ...
              {AVATAR_STACK.map((av, i) => (
                <div
                  ...
                  style={{
                    ...
                    flexShrink: 0,
                    boxShadow: `0 2px 8px ${av.color}44`,
                  }}
                >
                  {av.initials}
                </div>
            ...
            <span style={{ fontSize: 12.5, color: "rgba(255,255,255,0.45)", fontWeight: 500 }}>
              Trusted by{" "}
              <strong style={{ color: "rgba(255,255,255,0.75)", fontWeight: 700 }}>1,100+</strong>{" "}
      ...
      >
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 40px" }}>
          <div
            style={{ display: "flex", gap: 36, alignItems: "stretch" }}
            ...
            <div style={{ flexShrink: 0, width: 230 }} className="w-full lg:w-[230px] mb-8 lg:mb-0">
              <div
                style={{
                  height: "100%",
                  minHeight: 352,
                  background: "linear-gradient(160deg, hsl(158,64%,38%) 0%, hsl(158,64%,20%) 100%)",
                  borderRadius: 22,
                  padding: "40px 30px",
                  display: "flex",
                  flexDirection: "column" as const,
                  ...
                  position: "relative",
                  overflow: "hidden",
                  boxShadow: "0 24px 48px rgba(0,160,100,0.28)",
                }}
              >
                <div
                  style={{
            ...
            >
              <div
                style={{
                  ...
                  left: 0,
                  width: 100,
                  background: "linear-gradient(to right, #080809, transparent)",
                  zIndex: 10,
                  pointerEvents: "none",
                }}
              />
              <div
                style={{
                  ...
                  right: 0,
                  width: 100,
                  background: "linear-gradient(to left, #080809, transparent)",
                  zIndex: 10,
                  pointerEvents: "none",
                }}
              />
      ...
      <section id="testimonials" style={{ padding: "0 40px 130px" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          <div style={{ marginBottom: 64, textAlign: "center" }}>
            ...
            >
              Hear from the project managers, engineers, and heads who run India's biggest builds
              with Kinetic.
            </p>
          </div>
          <div
