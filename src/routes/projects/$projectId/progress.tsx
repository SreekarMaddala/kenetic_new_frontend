...
const MILESTONES = [
  { id: "M1", title: "Site Mobilization & Fencing", date: "01 Jan 2026", status: "Completed", progress: 100, owner: "Rajesh Kumar" },
  { id: "M2", title: "Excavation & Earthworks", date: "15 Feb 2026", status: "Completed", progress: 100, owner: "Amit Mishra" },
  { id: "M3", title: "Foundation & Footing", date: "10 Apr 2026", status: "Completed", progress: 100, owner: "L&T Structurals" },
  { id: "M4", title: "Basement Slab Casting", date: "05 Jun 2026", status: "In Progress", progress: 65, owner: "Amit Mishra" },
  { id: "M5", title: "Ground Floor Superstructure", date: "30 Jul 2026", status: "Delayed", progress: 15, owner: "Priya Sharma" },
  { id: "M6", title: "MEP Rough-ins (L1-L5)", date: "15 Sep 2026", status: "Pending", progress: 0, owner: "Metro MEP Services" },
  { id: "M7", title: "Facade & Glazing", date: "20 Nov 2026", status: "Pending", progress: 0, owner: "Glassco Inc." },
];
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative size-16">
            <svg className="size-full rotate-[-90deg]" viewBox="0 0 36 36">
              ...
              <path className="text-primary transition-all duration-1000 ease-out" strokeDasharray="42, 100" strokeWidth="3" stroke="currentColor" fill="none" strokeLinecap="round" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
            </svg>
          </div>
        </div>
      </div>
          ...
          {MILESTONES.map((m, i) => {
            ...
            return (
              <div key={m.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                {/* Icon */}
                <div className={`flex items-center justify-center size-10 rounded-full border-4 border-[color:var(--surface)] shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-sm z-10 ${
                  ...
                  {isCompleted ? <CheckCircle2 className="size-5" /> :
                   isInProgress ? <PlayCircle className="size-5" /> :
                   isDelayed ? <AlertTriangle className="size-4" /> :
                ...
                <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-border bg-[color:var(--surface)] shadow-sm hover:border-primary/40 transition-colors">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">{m.id}</span>
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${
                      isCompleted ? "bg-emerald-500/10 text-emerald-600" :
                      isInProgress ? "bg-blue-500/10 text-blue-600" :
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-[10px] font-semibold">
                      ...
                      <span className={isCompleted ? "text-emerald-600" : "text-primary"}>{m.progress}%</span>
                    </div>
